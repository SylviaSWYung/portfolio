  ...
  return (
    <section id="about" className="min-h-screen pt-22">
      <div className="flex flex-col xl:flex-row items-center mx-auto lg:gap-x-10 xl:gap-x-30 justify-center w-6/7 sm:w-full">
        <div className="flex flex-col">
          ...
          <motion.img
            ...
            className="relative hidden xl:block w-[300px] xl:w-[400px]"
          />
        </div>
        ...
        <img
          ...
          alt=""
          className="h-7/8 w-7/8 md:h-3/5 md:w-3/5 mr-2 xl:hidden"
        />
        <p className="z-10 font-inria text-center text-sm md:text-xl xl:text-lg xl:w-2/6 w-4/5">
      ...
      <img
        ...
        alt=""
        className="h-2/3 w-2/3 md:h-1/2 md:w-1/2 xl:hidden block mx-auto"
      />
    </section>
  );
};
